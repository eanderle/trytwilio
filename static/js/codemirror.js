...
CodeMirror.xmlHints['<'] = [
  'Response', 'Say', 'Play', 'Record', 'Gather', 'Sms'
];

CodeMirror.xmlHints['<Say '] = [
  'voice', 'language', 'loop'
];
CodeMirror.xmlHints['<Play '] = [
  'loop'
];
CodeMirror.xmlHints['<Record '] = [
  'action', 'method', 'timeout', 'finishOnKey', 'maxLength', 'transcribe', 'transcribeCallback', 'playBeep'
];
CodeMirror.xmlHints['<Gather '] = [
  'action', 'method', 'timeout', 'finishOnKey', 'numDigits'
];
CodeMirror.xmlHints['<Sms '] = [
  'to', 'from', 'action', 'method', 'statusCallback'
];

CodeMirror.xmlHints['<Response><'] =  [
    'Say', 'Play', 'Record', 'Gather', 'Sms'
];

var editor = CodeMirror.fromTextArea(document.getElementById("twiml-box"), {
      value: '',
      mode: 'text/html',
      lineNumbers: true,
      lineWrapping: 'true',
